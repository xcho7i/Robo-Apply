// DeleteCertificationModal.js
import React from "react";
import { IoMdClose } from "react-icons/io";
import Button from "../../Button";

const DeleteCertificationModal = ({ isOpen, onClose, onConfirm }) => {
  const handleOutsideClick = (event) => {
    if (event.target.id === "delete-certification-modal-container") {
      onClose();
    }
  };
  ...
  return (
    <div
      id="delete-certification-modal-container"
    ...
    >
      <div className="bg-modalPurple rounded-lg p-4 md:p-8 w-full md:max-w-[40%] relative border">
        ...
        <div className="flex justify-end space-x-4">
          ...
          <Button
            onClick={onConfirm}
            className="px-4 py-3 font-medium w-32 bg-gradient-to-b from-gradientStart to-gradientEnd text-primary rounded-lg hover:ring-2 hover:ring-gradientEnd"
          >
            Yes
          </Button>
        </div>
