// DeleteEducationModal.js
import React from "react";
import { IoMdClose } from "react-icons/io";
import Button from "../../Button";

const DeleteEducationModal = ({ isOpen, onClose, onConfirm }) => {
  const handleOutsideClick = (event) => {
    if (event.target.id === "delete-education-modal-container") {
      onClose();
    }
  };
  ...
  return (
    <div
      id="delete-education-modal-container"
