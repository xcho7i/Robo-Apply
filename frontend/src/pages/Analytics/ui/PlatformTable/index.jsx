...
//       <div className="w-full block lg:flex  items-center gap-5 space-y-3 md:space-y-0">
//         <div className="flex w-full items-center gap-2 justify-center md:justify-start text-primary text-2xl font-medium">
//           <p>Total Jobs:</p>
//           <p>{filteredData.length}</p>
//         </div>
//         <div className="flex w-full items-center justify-center md:justify-end gap-5">
...
//         </div>
//       </div>
//       <div className="w-full flex items-center justify-between px-2 py-5 md:py-10">
//         <div className="w-full flex items-center justify-center md:justify-normal gap-2 text-2xl font-medium">
//           <p className="text-primary  text-xl">Platform: </p>
//           <p className="text-primary ">{selectedPlatform.platformName}</p>
//         </div>
//         <div className="w-full flex items-center gap-2 justify-end  md:pt-0">
//           <img
//             src={selectedPlatform.icon}
//             loading="lazy"
//             className="w-10 h-10"
//           />
//           <p className="text-2xl font-medium hidden md:block">
//             {selectedPlatform.platformName}
//           </p>
//         </div>
//       </div>

//       {/* Filter and Job Details Table */}
//       <div className="overflow-x-auto w-[99%] md:w-full  md:mt-5">
//         <table className="w-full overflow-x-auto text-left border-collapse ">
//           {/* <div className="overflow-x-auto w-full md:mt-5">
...
const PlatformTable = ({ onGoBack, selectedPlatform }) => {
  ...
  // Fetch job data from API based on selected platform
    ...
    try {
      ...
      if (result.success && result.data) {
        const mappedData = result.data.map((job) => ({
          ...
          byResume: job.resumeChosen,
          jobDate: new Date(job.jobDate).toISOString().split("T")[0],
          jobLink: job.jobLink,
        }));
