...
const CreditConfirmationModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onConfirm,
  creditValidation,
          ...
          <div className="bg-almostBlack/80 rounded-lg p-4 mb-4 border border-customGray">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                ...
                <p className="text-lightGrey">Tailored Resume Generation</p>
              </div>
              <div className="flex justify-between">
                <div>
                  <span className="font-medium text-primary">Resumes:</span>
                  <p className="text-lightGrey">
                    {creditValidation.creditCost === 0
                      ? "FREE"
                      : `${creditValidation.creditCost / 15} ${
                          creditValidation.creditCost / 15 > 1
                            ? "Resumes"
                            : "Resume"
                        } `}
                  </p>
